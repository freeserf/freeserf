...
class DataSourceBase : public Data::Source {
 ...
 public:
  ...
  virtual Data::PSprite get_sprite(Data::Resource res, size_t index, const Data::Sprite::Color &color, int mutate = 0);  // for FogOfWar

  //virtual Data::MaskImage get_sprite_parts(Data::Resource res, size_t index) = 0;
  virtual Data::MaskImage get_sprite_parts(Data::Resource res, size_t index, int mutate = 0) = 0;
