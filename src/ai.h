...
private:
	...
	// ai.cc 
	//
	void AI::do_place_castle();
	void AI::do_get_inventory(MapPos);
	void AI::do_save_game();
	void AI::do_update_clear_reset();
	void AI::do_get_serfs();
	void AI::do_debug_building_triggers();
	void AI::do_promote_serfs_to_knights();
	void AI::do_connect_disconnected_flags();
	void AI::do_spiderweb_roads1();
	void AI::do_spiderweb_roads2();
	void AI::do_build_better_roads_for_important_buildings();
	void AI::do_fix_stuck_serfs();
	void AI::do_fix_missing_transporters();
	void AI::do_send_geologists();
	void AI::do_build_rangers();
	void AI::do_remove_road_stubs();
	void AI::do_demolish_unproductive_stonecutters();
	void AI::do_demolish_unproductive_mines();
	void AI::do_demolish_excess_lumberjacks();
	void AI::do_demolish_excess_fishermen();
	void AI::do_manage_tool_priorities();
	void AI::do_manage_mine_food_priorities();
	void AI::do_balance_sword_shield_priorities();
	void AI::do_attack();
	void AI::do_manage_knight_occupation_levels();
	 void AI::do_place_mines(std::string, Building::Type, Map::Object, Map::Object, int, double);
	void AI::do_place_coal_mines(); //wrapper around do_place_mines
	void AI::do_place_iron_mines(); //wrapper around do_place_mines
	void AI::do_place_gold_mines(); //wrapper around do_place_mines
	void AI::do_build_sawmill_lumberjacks();
	bool AI::do_wait_until_sawmill_lumberjacks_built();
	void AI::do_build_stonecutter();
	void AI::do_create_defensive_buffer();
	void AI::do_build_toolmaker_steelsmelter();
	void AI::do_build_food_buildings_and_3rd_lumberjack();
	void AI::do_connect_coal_mines();
	void AI::do_connect_iron_mines();
	void AI::do_build_steelsmelter();
	void AI::do_build_blacksmith();
	void AI::do_build_gold_smelter_and_connect_gold_mines();
	void AI::do_build_warehouse();
};
