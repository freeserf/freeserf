...
static const unsigned int min_open_positions_burn_excess_forester = 20;  // when max_planks reached, burn any forester that has fewer than this many open positions withinits working radius
